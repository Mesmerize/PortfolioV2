        ...
        <section>
            ...
            <div className='content-section'>
                ...
                <div className='buttons'>
                    <a href='/resume/FrontEndResume.pdf' className='space' download><button id='btn'>RÈSUMÈ</button></a>
                    <a href="#contact-me" className='space'><button id='btn'>CONTACT ME</button></a>
                </div>
                {/* End of Experimental */}
